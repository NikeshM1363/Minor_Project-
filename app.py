...
inflation_data = load_inflation_data("FINAL_PROJECT\static\inflation_data.json")
...
def get_started():
    ...
    try:
        countries_data = load_data('FINAL_PROJECT\static\countries.json')
...
def predict():
    try:
        ...
        backtracked_values_data = backtrack_values(total_cost, "FINAL_PROJECT\static\inflation_data.json", country)
